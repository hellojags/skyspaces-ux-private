...
function createData(fileName, activityTime, activityType, spaces) {
  return { fileName, activityTime, activityType, spaces };
}
...
const headCells = [
  ...
  { id: "spaces", numeric: true, disablePadding: false, label: "Spaces" },
];
